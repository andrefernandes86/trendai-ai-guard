...
def main() -> None:
    ...
    print()
    print("    1) 256 MB    Max safe file: ~1 MB PDFs, ~10 MB plain text")
    print("                 Cost per scan: ~$0.000003   (~$0.03 per 10,000 scans)")
    print("                 Risk:          may OOM on large PDFs / complex Office docs")
    print()
    print("    2) 512 MB    Max safe file: ~5 MB PDFs, ~10 MB Office docs")
    print("                 Cost per scan: ~$0.000006   (~$0.06 per 10,000 scans)")
    print("                 [Recommended for typical mixed workloads]")
    print()
    print("    3) 1024 MB   Max safe file: ~15 MB PDFs, ~30 MB Office docs")
    print("                 Cost per scan: ~$0.000012   (~$0.12 per 10,000 scans)")
    print("                 Use when you scan large PDFs regularly.")
    print()
    print("    4) 2048 MB   Max safe file: ~50 MB PDFs, ~100 MB Office docs")
    print("                 Cost per scan: ~$0.000023   (~$0.23 per 10,000 scans)")
    print("                 ~4x the cost of 256 MB; only for very large files.")
    print()
    print("  Costs are AWS Lambda only (us-east-1, x86_64) and exclude AI Guard")
    print("  API charges. Estimated for a typical 500 KB file scan.")
    print()
    mem_choice = ask("Choose", default="2",
                     validator=lambda v: None if v in ("1", "2", "3", "4")
